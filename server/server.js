...
app.use(cors());
app.use(bodyParser.json())//when u r converting stuff treat it as jason
//we gonna create a "router' so we can do in a DRY way similar routes
const teasRouter = createRouter(dogs);
